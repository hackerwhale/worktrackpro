...
var EmployeeTable = function (_a) {
    ...
    var employees = users.filter(function (user) { return user.role !== 'admin'; });
    return (<div>
      ...
      <div className="overflow-x-auto">
        <table className="min-w-full divide-y divide-neutral-200 dark:divide-neutral-700">
          ...
          <tbody className="divide-y divide-neutral-200 dark:divide-neutral-700">
            {employees.map(function (employee) { return (<tr key={employee.id}>
                ...
                <td className="whitespace-nowrap px-4 py-4">
                  <span className={cn("inline-flex rounded-full px-2 py-1 text-xs font-medium", employee.id !== 6
                ...
                <td className="whitespace-nowrap px-4 py-4 text-right text-sm">
                  <Link href={"/employees/".concat(employee.id)}>
