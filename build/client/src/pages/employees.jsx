...
var Employees = function () {
    ...
    var _b = useState(false), showAddDialog = _b[0], setShowAddDialog = _b[1];
    var _c = useQuery({
        queryKey: ["/api/users"],
    }), users = _c.data, isLoading = _c.isLoading;
    var filteredUsers = users === null || users === void 0 ? void 0 : users.filter(function (user) {
        var _a;
        return user.firstName.toLowerCase().includes(search.toLowerCase()) ||
            user.lastName.toLowerCase().includes(search.toLowerCase()) ||
            ((_a = user.position) === null || _a === void 0 ? void 0 : _a.toLowerCase().includes(search.toLowerCase()));
    });
    return (<div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Dialog open={showAddDialog} onOpenChange={setShowAddDialog}>
          ...
          <DialogContent className="sm:max-w-[500px]">
            ...
            <AddEmployeeForm onSuccess={function () { return setShowAddDialog(false); }}/>
          </DialogContent>
        </Dialog>
      </div>
      ...
      <div className="relative">
        ...
        <Input type="search" placeholder="Search employees..." className="pl-10" value={search} onChange={function (e) { return setSearch(e.target.value); }}/>
      </div>
      ...
      {isLoading ? (<div className="flex justify-center py-10">
          ...
          {filteredUsers === null || filteredUsers === void 0 ? void 0 : filteredUsers.map(function (user) { return (<Card key={user.id} className="overflow-hidden">
              ...
              <CardContent className="pt-12">
                ...
                <div className="mt-4 flex justify-between">
                  <Link href={"/employees/".concat(user.id)}>
